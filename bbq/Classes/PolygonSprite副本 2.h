...
public:
    ...
    PhysicsBody* createBodyForWorld(PhysicsWorld* world, Vec2 position, float rotation, Vec2* vertices, int vertexCount, float density, float friction, float restitution);
