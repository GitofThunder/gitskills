...
bool PRKitDemoScene::init()
{
    ...
    auto color_bg = LayerColor::create(Color4B(255, 255, 255, 128));
    //addChild(color_bg);
    ...
    */
    ...
    Vector2dVector testPoints;
    testPoints.push_back(Vector2d(0, 0));
    testPoints.push_back(Vector2d(0, 2048));
    testPoints.push_back(Vector2d(2048, 2048));
    testPoints.push_back(Vector2d(2048, 0));
    PRFilledPolygon *test = PRFilledPolygon::filledPolygonWithPointsAndTexture(testPoints, "xigua_test.png");
    addChild(test,1);
    test->setPosition(Vec2(-256, -256));
    
    Texture2D *texture = Director::getInstance()->getTextureCache()->addImage("boluo.png");
